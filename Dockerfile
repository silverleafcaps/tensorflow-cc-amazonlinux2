...
RUN yum install -y git curl git python python3-dev python3-numpy sudo wget tar make gcc gcc-c++ patch autoconf automake libtool python-pip cmake3
RUN pip install future

# bazel version required is 0.15.2 anything else might not work!
...
# Need g++-7
RUN ln -s /usr/bin/g++ /usr/bin/g++-7
